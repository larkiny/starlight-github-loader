...
For in-depth details, visit the [opt-in](/reference/algokit-cli/#opt-in) and [opt-out](/reference/algokit-cli/#opt-out) sections in the AlgoKit CLI reference documentation.
